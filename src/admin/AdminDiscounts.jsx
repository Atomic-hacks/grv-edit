    ...
    <>
      <label className="text-sm">
        ...
        <input
          ...
          className="w-full border border-[var(--line)] px-3 py-2.5 uppercase"
        />
      </label>
      <label className="text-sm">
        ...
        <select
          ...
          value={values.type}
          onChange={updateField(setter)}
          className="w-full border border-[var(--line)] bg-white px-3 py-2.5"
        >
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12 md:px-12 md:py-20">
      ...
      <form
        ...
        className="mt-8 grid gap-4 border-b border-[var(--line)] pb-8 md:grid-cols-3"
      >
        {fields(form, setForm)}
        <button
          type="submit"
          disabled={saving}
          className="border border-[var(--ink-900)] bg-[var(--ink-900)] px-5 py-2.5 text-sm font-medium text-white disabled:opacity-50 md:col-span-3 md:justify-self-start"
        >
          ...
          <tbody>
            ...
            {discounts.map((discount) =>
              editingId === discount.id ? (
                <tr key={discount.id} className="border-b border-[var(--line)]">
                  <td colSpan="5" className="px-3 py-4">
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        disabled={saving}
                        className="border border-[var(--ink-900)] bg-[var(--ink-900)] px-3 py-2 text-sm text-white"
                      >
                        Save
                      </button>
                      <button
